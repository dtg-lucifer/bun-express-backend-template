...
export class AppError extends Error {
	...
	constructor(message: string, statusCode: number = 500, code: ErrorCode = ErrorCode.INTERNAL_SERVER_ERROR, isOperational: boolean = true, details?: unknown) {
		super(message);
...
export class InternalServerError extends AppError {
	constructor(message: string = ErrorMessages[ErrorCode.INTERNAL_SERVER_ERROR], code: ErrorCode = ErrorCode.INTERNAL_SERVER_ERROR, details?: unknown) {
